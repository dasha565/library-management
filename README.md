...
*   **Infrastructure:** Render (Deployment), Code Climate (Static Analysis).

## 🚀 Ссылка на деплой
Приложение доступно в облаке: [Library Management App](https://library-management-jxgq.onrender.com)

## 📊 Качество кода
Статус анализа кода доступен в [Code Climate Quality Report](https://codeclimate.com/github/dasha565/library-management).

## 💻 Локальный запуск

1.  **Клонируйте репозиторий:**
    ```bash
    git clone https://github.com/dasha565/library-management.git
